...
function App() {
  return (
    <Router>
        ...
        <Route exact path='/community-interaction' Component={PatientCommunityinteraction}/>
        ...
        <Route exact path='/professional-collab' Component={DoctorProfessionalCollab}/>
...
<Route exact path='/facility-management' Component={HealthadminFacilityManagement}/>
