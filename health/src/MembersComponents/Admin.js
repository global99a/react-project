  ...
  return (
    ...
    <DashboardContainer>
      <Card>
        ...
        <Value>{monthlyData.reduce((acc, data) => acc + data.totalUsers, 0)}</Value>
        <BarChart
  data={{
...
/>
    ...
    <div className='card'>
    <Link to='/healthcareprovider-management'>HealthcareProviderManagement</Link>
    </div>
    <div className='card'>
    <Link to='/system-configuration'>SystemConfiguration</Link>
    </div>
    <div className='card'>
    <Link to='/data-oversight'>DataOversight</Link>
    </div>
    <div className='card'>
    <Link to='/report-generation'>ReportGeneration</Link>
    </div>
    <div className='card'>
